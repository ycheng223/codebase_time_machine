@echo off
REM Auto-generated script to build executable for Codebase_Time_Machine
...
echo === Build Complete ===
echo Executable location: dist\codebase_time_machine.exe
echo Run with: .\dist\codebase_time_machine.exe
